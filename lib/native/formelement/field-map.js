...
window.onload = function() {
  ...
  google.maps.event.addListener(mark, 'dragend', function(a) {
...
document.getElementById('latlong').value = place.geometry.location.lat().toFixed(4) + ', ' + place.geometry.location.lng().toFixed(4) + ', '+map.getZoom()+','+map.getMapTypeId();
...
google.maps.event.addListener(marker, 'dragend', function(a) {
    ...
    google.maps.event.addListener(marker, 'push', function(a) {
        console.log(a);
	//var t =document.getElementById('map');
        //var div = document.createElement('div');
        //div.innerHTML = a.latLng.lat().toFixed(4) + ', ' + a.latLng.lng().toFixed(4);
