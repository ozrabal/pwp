...
?>
		...
		<br><a class="click" data-form-name="<?php echo get_the_title() ?>" href="#<?php echo get_the_ID() ?>">
            <?php the_title(); ?>
            </a>
	...
	<footer>
		<div class="inner text-right">
			<button id="btn-cancel" class="button-small"><?php _e( 'Cancel' , 'iframe_modal' ); ?></button>
