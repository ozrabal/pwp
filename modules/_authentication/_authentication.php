...
function addMyRules(){
   ...
   //dump(pll_current_language());
    if(  pll_current_language() == 'pl' && !is_admin()){
    ...
    add_rewrite_rule('^user/?','index.php?page_id=60','top');
     ...
     add_rewrite_rule('^en/user([^/]*)/([^/]*)/?','index.php?page_id=167&action=showprofile','top');
    add_rewrite_rule('^en/user/profile([^/]*)/?','index.php?page_id=167&action=showprofile','top');
    add_rewrite_rule('^en/user/?','index.php?page_id=167','top');
    }
